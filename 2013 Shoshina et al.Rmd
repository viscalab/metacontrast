...
```{r}
sz_0.4_pooled <- pool.groups(n1 = 25,   # sample size group 1
...
Control: mean = 15.2 ; sd = 12.0
```{r}
shoshina_2013_es_sf0.4 <- esc_mean_sd(grp1m = 15.2, grp2m = sz_0.4_pooled$Mpooled,  # group mean
            grp1sd = 12.0, grp2sd = sz_0.4_pooled$SDpooled, # group sd
            grp1n = 20, grp2n = sz_0.4_pooled$Npooled, 
            es.type = "g")
...
Schizophrenia group 2: mean = 63.6 ; sd = 34.1
```{r}
sz_3.6_pooled <- pool.groups(n1 = 25,   # sample size group 1
            n2 = 20,   # sample size group 2
...
Control: mean = 73.4 ; sd = 39.8
```{r}
shoshina_2013_es_sf3.6 <- esc_mean_sd(grp1m = 73.4, grp2m = sz_3.6_pooled$Mpooled,  # group mean
            grp1sd = 39.8, grp2sd = sz_3.6_pooled$SDpooled, # group sd
            grp1n = 20, grp2n = sz_3.6_pooled$Npooled, 
            es.type = "g")
...
Schizophrenia group 2: mean = 14.5 ; sd = 10.7
```{r}
sz_17.9_pooled <- pool.groups(n1 = 25,   # sample size group 1
            n2 = 20,   # sample size group 2
...
Control: mean = 16.4 ; sd = 13.07
```{r}
shoshina_2013_es_sf17.9 <- esc_mean_sd(grp1m = 16.4, grp2m = sz_17.9_pooled$Mpooled,  # group mean
            grp1sd = 3-13.07, grp2sd = sz_17.9_pooled$SDpooled, # group sd
            grp1n = 20, grp2n = sz_17.9_pooled$Npooled, 
            es.type = "g")
...
shoshina_2013$medication <- "medicated" #n=45 medicated
shoshina_2013$cpz <- NA
shoshina_2013$task <- "2IFC"
shoshina_2013$SF <- "0.4, 3.6, 17.9"
...
shoshina_2013$calculation_certainty <- "unsure" #scale is "sure", "unsure", "very unsure"
...
## Side note 1
I pooled group 1 and 2 from schizophrenia to calculate the es control vs schizophrenia. Pretty sure I have done it correct.
