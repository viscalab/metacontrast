...
Extract data from figure 2? (use plotdigitizer)
...
```{r}
cimmer_2006_es <- esc_mean_sd(grp1m = 2.4629921171292537, grp2m = 2.266972,  # group mean
            grp1sd = c_sd, grp2sd = 0.1514185, # group sd
            grp1n = 20, grp2n = 44, 
            es.type = "g")
cimmer_2006_es
```
...
cimmer_2006$method <- "adaptive" # adaptive, mc, ... (Do they use a special method to display contrast?) 
...
cimmer_2006$lapses <- "TRUE"  #In lapses, we can include whether they control for lapses (TRUE) or not (FALSE).
cimmer_2006$calculation_statistic <- "m and sd"  #"t-test", "m and sd"
cimmer_2006$calculation_data <- "scrapping, calculate sd" #"scrapping", "reported", "raw"
...
No, only the mean and the 95% confidence intervals are provided. Not possible to calculate the es with this information.

Asked authors for data.