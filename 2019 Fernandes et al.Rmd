...
fernandes_2019$calculation_statistic <- "ask for data"  
fernandes_2019$calculation_data <- "ask for data" 
fernandes_2019$calculation_certainty <- "unsure" #scale is "sure", "unsure", "very unsure"
