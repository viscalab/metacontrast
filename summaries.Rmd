...
## 2013_caldarone Summarizing table

```{r}
caldarone_2013_summary <- caldarone_2013 |> 
  select(es, se, study, calculation_statistic, calculation_data, calculation_certainty)
```
...
## 2013_shoshina_and_shelepin Summarizing table

```{r}
shoshina_and_shelepin_2013_summary <- shoshina_and_shelepin_2013 |> 
  select(es, se, study, calculation_statistic, calculation_data, calculation_certainty)
```
...
studies <- schwartz_1987_summary |>
  ...
  bind_rows(caldarone_2013_summary) |>
  bind_rows(cadenhead_2013_summary) |>
  bind_rows(shoshina_and_shelepin_2013_summary) |>
