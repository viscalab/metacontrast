...
Control (n=15)
SF = 0.9, mean = 76.40378395835765, SEM-interval = 71.98737669712817 (lower limit)
SF = 3.8, Not in graph 
SF = 15 , mean = 67.35015261075841, SEM-interval = 63.1545722830155 (lower limit)

Schizophrenia (n=19)
SF = 0.9, mean = 80.15773063582003, SEM-interval = 85.67823213109716 (upper limit)
SF = 3.8, Not in graph 
SF = 15 , mean = 49.24290002390624, SEM-interval = 53.659307285135725 - 45.709780279930435
