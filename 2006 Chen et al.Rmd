...
## Calculate effect size:
  ...
  use the t-statistic
  I only calculate for scz vs ctrl
...
2) Schizophrenia vs control (not significant)
  -> t(1,44) = 0.49 , p = 0.627
```{r}
chen_2006_es_t_statistic <- esc_t(t = 0.49, # t-statistic
      grp1n = 25,
      grp2n = 25,
      es.type = "g")
chen_2006_es_t_statistic
...
chen_2006$method <- "staircase (1- up 3- down)" # adaptative, mc, ... 
chen_2006$medication <- "?" #TRUE #n=24 medicated, n=1 unmedicated
chen_2006$cpz <- "388"  #in mg
chen_2006$task <- "psychophysical" 
chen_2006$SF <- 0.5
chen_2006$BPRS <- 43
...
chen_2006$lapses <- "?"  #In lapses, we can include whether they control for lapses (TRUE) or not (FALSE).
...
Why is the effect size different when I calculate it with the mean(sd) vs when calculated with the t-statistic?

## Side note 2

Only 2) is important, namely control vs schizophrenia.
