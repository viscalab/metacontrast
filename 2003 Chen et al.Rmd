...
Participants: 1) Schizophrenia n = 45 n = 12 with schizophrenia n = 33 with schizoaffective disorder also classified according to type of antipsychotic medication
...
<<<<<<< HEAD
Contrast sensitivity (p3) 1) Schizophrenia group (as a whole) vs healthy controls (significant) scz: mean = 0.0036 ; SD = 0.0039 ctrl: mean = 0.0025 ; SD = 0.0016 t = 2.04, df = 82, p\<0.05 Effect size of group difference: 0.71 (small)
=======
